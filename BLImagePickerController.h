 ...
 *  获取图片 代理
 */
@protocol BLImagePickerControllerDelegate <NSObject>
...
@interface BLImagePickerController : NSObject
 ...
 *  选取图片结束的代理
 */
@property (nonatomic,weak) id<BLImagePickerControllerDelegate>delegate;
